...
<head>
    ...
    <link rel="icon" href="<?php echo base_url('assets/') ?>img/lp3i/logo3.png" type="image/x-icon" />
            ...
            <div class="container-fluid h-100">
                <div class="row flex-row h-100 bg-white">
                    <div class="col-xl-8 col-lg-6 col-md-5 p-0 d-md-block d-lg-block d-sm-none d-none">
                        <div class="lavalite-bg" style="background-image: url('<?php echo base_url('assets/') ?>img/auth/bg-lp3i.jpg')">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-7 my-auto p-0">
                        <div class="authentication-form mx-auto">
                            <div style="padding-left: 80px; padding-right: 70px;">
                                <a href="<?php echo base_url() ?>"><img src="<?php echo base_url('assets/') ?>img/lp3i/logo4.png" alt="Logo LP3I" width="150px"  ></a>
                            </div>
                            <br>
