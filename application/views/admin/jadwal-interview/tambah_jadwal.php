  ...
  <div class="content">
    <div class="page-inner">
      <div class="page-header">
        <h4 class="page-title">Tambah Jadwal Interview</h4>
        <ul class="breadcrumbs">
          ...
          <li class="nav-item">
            <a href="#">Tambah Jadwal Interview</a>
          </li>
        </ul>
      </div>
          ...
          <div class="card">
            <div class="card-header">
              ...
              <div class="d-flex align-items-center">
                <h4 class="card-title">Tambah Jadwal Interview</h4>
                
              </div>
            </div>
            <div class="card-body">

              <form action="<?php   echo base_url('Admin/addJadwal') ?>" method="post">
                <div class="row">
                  <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                      ...
                      <input name="fk_nim" id="nim" type="hidden" class="form-control" required="true" placeholder="nama lengkap">
                    </div>
                  </div>
                  <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                      <label>Nama Perusahaan</label>
                      <input type="text" required="true" name="nama_perusahaan" class="form-control"  id="nama"  placeholder="Masukan Nama Perusahaan">
                      <input name="fk_perusahaan" id="id_perusahaan" type="hidden" class="form-control" required="true">
                    </div>
                  </div>
                  ...
                  <div class="col-md-6 col-lg-6">
                    <div class="form-group">
                      ...
                      <input name="tgl_interview" type="date" class="form-control" required="true">
                    </div>
                  </div>
