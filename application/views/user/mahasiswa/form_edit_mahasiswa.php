				...
				<div class="row">
					<div class="col-md-12">
						<div class="card">
							...
							<div class="card-body">
								<?php echo form_open_multipart('user/editMahasiswa') ?>
								<div class="row">
							...
							<div class="card-action">
								...
								<a href="<?php echo base_url('user/biodata/'.$this->session->userdata('username')) ?>" class="btn btn-danger">Batal</a>
							</div>
						</form>
					</div>
				</div>
